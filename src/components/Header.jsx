    ...
    <>
      <header className={`header ${scrolled ? 'scrolled' : ''}`}>
        <div className="header-left" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <Link to="/" className="mobile-hide-logo" style={{ fontSize: '1.5rem', fontFamily: '"Cinzel", serif', fontWeight: 'bold', color: 'var(--text-light)', textDecoration: 'none', letterSpacing: '2px' }}>
            GALJIN DVOR
          </Link>
          <div className={`hamburger ${menuOpen ? 'active' : ''}`} onClick={toggleMenu} style={{ marginLeft: 'auto' }}>
            <span></span>
            <span></span>
            <span></span>
          </div>
